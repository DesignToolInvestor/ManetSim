...
from Vestigial.Sinc import SincFit
...
if __name__ == "__main__":
  ...
  fit = SincFit(sampVal, mapProb, nSinc)
  ...
  plot.savefig(f'Data/EampBCdf/dist_fit_b_{seed}_{nSamp}_{nSinc}.png')
